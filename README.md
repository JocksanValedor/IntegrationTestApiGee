...
NOTA: para poder ejecutar nuestro proyecto debemos validar que no tengamos restricciones en la ejecucion de comandos
ejecutemos el comendo Get-ExecutionPolicy si el resultado es Unrestricted estamos correctos pero si tenemos 
Restricted ejecutamos  Get-ExecutionPolicy Unrestricted
